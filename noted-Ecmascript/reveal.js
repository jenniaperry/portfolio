	...
	function showPreview( url ) {
		...
		dom.overlay.innerHTML = [
			'<header>',
				...
				'<a class="external" href="../../noteEcmascript/'+ url +'" target="_blank"><span class="icon"></span></a>',
			'</header>',
			'<div class="spinner"></div>',
			'<div class="viewport">',
				'<iframe src="../../noteEcmascript/'+ url +'"></iframe>',
			'</div>'
		].join('');
			...
			if( background.hasAttribute( 'data-loaded' ) === false ) {
				...
				// Videos
					...
					backgroundVideo.split( ',' ).forEach( function( source ) {
						video.innerHTML += '<source src="../../noteEcmascript/'+ source +'">';
					} );
